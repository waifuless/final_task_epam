...
public class DeleteAuctionParticipationCommand implements AjaxCommand {

    private final static Logger LOG = LoggerFactory.getLogger(DeleteAuctionParticipationCommand.class);
    ...
    DeleteAuctionParticipationCommand() {
    }
    ...
    public AjaxCommandResponse execute(CommandRequest request) throws Exception {
        try {
            ...
            auctionParticipationService.deleteParticipation(userId, request.getParameter("lotId"));
