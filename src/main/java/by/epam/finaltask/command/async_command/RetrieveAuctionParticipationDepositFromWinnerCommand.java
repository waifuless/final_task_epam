...
public class RetrieveAuctionParticipationDepositFromWinnerCommand implements AjaxCommand{
    ...
    RetrieveAuctionParticipationDepositFromWinnerCommand() {
    }
    ...
    public AjaxCommandResponse execute(CommandRequest request) throws Exception {
        try {
            ...
            auctionParticipationService.retrieveWinnerParticipationByLotOwner(userId, request.getParameter("lotId"));
