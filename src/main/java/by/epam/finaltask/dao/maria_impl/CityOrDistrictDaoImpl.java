...
public class CityOrDistrictDaoImpl extends GenericDao<CityOrDistrict> implements CityOrDistrictDao {
    ...
    private final static Logger LOG = LoggerFactory.getLogger(CityOrDistrictDaoImpl.class);

    private static volatile CityOrDistrictDaoImpl instance;

    private CityOrDistrictDaoImpl() throws DataSourceDownException {
    ...
    public static CityOrDistrictDaoImpl getInstance() {
        if (instance == null) {
            synchronized (CityOrDistrictDaoImpl.class) {
                if (instance == null) {
                    instance = new CityOrDistrictDaoImpl();
                }
            }
        }
        return instance;
