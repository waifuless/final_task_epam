            ...
            <li class="nav-item mx-3 my-2">
                ...
                <div class="collapse show" id="params">
                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                        <li><a href="#" class="rounded nav-link link-dark">Regions</a></li>
                        <li><a href="#" class="rounded nav-link link-dark">Cities(districts)</a></li>
                        <li><a href="#" class="rounded nav-link link-dark">Categories</a></li>
                    </ul>
                </div>
            </li>
            <li class="nav-item">
